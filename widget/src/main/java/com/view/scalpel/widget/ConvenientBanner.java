...
import com.view.scalpel.widget.banner.CBLoopViewPager;
import com.view.scalpel.widget.banner.CBPageAdapter;
import com.view.scalpel.widget.banner.CBPageChangeListener;
import com.view.scalpel.widget.banner.CBViewHolderCreator;
import com.view.scalpel.widget.banner.ViewPagerScroller;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setPageTransformer(Transformer transformer) {
        try {
            ...
            String className = pkName  +".banner." + transformer.getClassName();
            viewPager.setPageTransformer(true, (ViewPager.PageTransformer) Class.forName(className).newInstance());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return this;
