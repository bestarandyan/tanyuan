package com.view.scalpel.widget.mullistview;
...
public class MultiColumnPullToRefreshListView extends MultiColumnListView {
	...
	public void setShowLastUpdatedText(boolean showLastUpdatedText){
		...
		if(!showLastUpdatedText) lastUpdatedTextView.setVisibility(GONE);
	}
	...
	private void setHeaderPadding(int padding){
		...
		ViewGroup.MarginLayoutParams mlp = (ViewGroup.MarginLayoutParams) header.getLayoutParams();
...
//				bounceAnimation.setInterpolator(new OvershootInterpolator(BOUNCE_OVERSHOOT_TENSION));
	...
	private void setUiRefreshing(){
		...
		refreshingIcon.setVisibility(GONE);
